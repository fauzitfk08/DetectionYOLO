...
from yolo_predictions_internet import YOLO_Pred_Internet
from PIL import Image
import numpy as np

st.set_page_config(page_title="Predictions Internet",
                   layout='wide',
...
with st.spinner('Please wait while your model is loading'):
    yolo = YOLO_Pred_Internet(onnx_model='./models/bestinternet.onnx',
