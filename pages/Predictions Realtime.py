...
from yolo_predictions_realtime import YOLO_Pred_Realtime
from PIL import Image
import numpy as np

st.set_page_config(page_title="Predictions Realtime",
                   layout='wide',
...
with st.spinner('Please wait while your model is loading'):
    yolo = YOLO_Pred_Realtime(onnx_model='./models/bestrealtime.onnx',
